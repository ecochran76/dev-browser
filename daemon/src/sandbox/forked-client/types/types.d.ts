...
export interface Page {
  ...
  /**
   * Returns an AI-optimized aria snapshot while preserving the older dev-browser result shape.
   * @param options
   */
  snapshotForAI(options?: {
    ...
    /**
     * Reuses Playwright's aria snapshot tracking to request an incremental update for the same logical snapshot.
     */
    track?: string;
